...
repo นี้แจกฟรีสำหรับการใช้งานส่วนตัว การเรียนรู้ และการใช้งานภายในองค์กรแบบไม่เชิงพาณิชย์เท่านั้น โดยไม่มี warranty และไม่รับผิดชอบความเสียหาย ดูเพิ่มเติมใน [LICENSE.md](../LICENSE.md)
